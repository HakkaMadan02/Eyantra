...
#		self.drone_position = [self.x, self.y, self.z]
        ...
        self.min_values = [1100,1100,1100]
	...
	def whycon_callback(self,msg):
		...
		self.drone_position[1] = msg.poses[1].position.x
		self.drone_position[2] = msg.poses[2].position.x
	...
	def pitch_set_pid(self,pchh):
		self.Kp[1] = pchh.Kp * 0.01
		self.Ki[1] = pchh.Ki * 0.001
		self.Kd[1] = pchh.Kd * 0.6

	def roll_set_pid(self,rul):
		self.Kp[0] = rul.Kp * 0.01
		self.Ki[0] = rul.Ki *0.001
		self.Kd[0] = rul.Kd * 0.6
